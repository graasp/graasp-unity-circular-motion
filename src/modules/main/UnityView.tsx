...
const UnityView = (props: UnityViewProps): JSX.Element => {
  ...
  const {
    ...
    loaderUrl: './BuildCircularSpace/Build/BuildCircularSpace.loader.js',
    dataUrl: './BuildCircularSpace/Build/BuildCircularSpace.data',
    frameworkUrl: './BuildCircularSpace/Build/BuildCircularSpace.framework.js',
    codeUrl: './BuildCircularSpace/Build/BuildCircularSpace.wasm',
  });
