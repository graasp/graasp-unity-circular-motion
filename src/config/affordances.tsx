...
import CentralSettings from '@/modules/main/affordances/CentralSettings';
import GeneralSettings from '@/modules/main/affordances/GeneralSettings';
import GravitationSettings from '@/modules/main/affordances/GravitationView';
...
export function GetAffordancesList(): ListAffordances[] {
  ...
  return [
    ...
    },
    {
      ...
      components: <GravitationSettings />,
    },
  ];
}
